...
$(document).on('click', '.dropdown-menu li a.selected_hypoth', function() {
    var selected_hyp = $(this).text().trim();
    var position = hypotheses.indexOf(selected_hyp);
...
$(document).on('click', '.accordion-body ul li a.selected2', function() {
    var aifid = $(this).text().trim().replace(':', '');
...
function zoomToElement(id) {
   ...
   // zoomToPathWithID("node9");
    
    var value = $('#hypothesis').text();
    
    
 //   var selected_hyp = document.getElementById('hypothesis').innerHTML;
 //   console.log(value);
  //  var origs = s.viewBox.width;
    
    
  //  var node = document.getElementById("node12");
   // var nBBox = node.getBBox();
//    zoomToPathWithID("node1");
 //   console.log("X:" + nBBox.x + "  Y:" + nBBox.y);
//    panZoomInstance.zoomAtPoint(6,{x: 360, y: 250});
}
...
function zoomToPathWithID(id){
  ...
  //var heightTest = $('#canvasclass');
   ...
   var hAdj = document.getElementById('tab-content').offsetHeight;
   var wAdj = document.getElementById('tab-content').offsetWidth;
   //var hAdj = 500;
   //console.log(wAdj);
   //   console.log(id);
   //   console.log('got here');
